...
# DEBUG: mostrar status e primeiros bytes da resposta
print("DEBUG >> Status:", response.status_code)
print("DEBUG >> Raw response (hex):", response.content[:100].hex())
print("DEBUG >> Raw response (ascii):", response.content[:200])
